...
function CurrentWeather({ city, unit, isFavorite, onToggleFavorite }) {
  ...
  return (
    <div className="mt-4 sm:mt-6 p-4 sm:p-6 bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700">
      <div className="flex items-center justify-between">
        ...
        <span className="text-4xl sm:text-5xl">{city.icon}</span>
      </div>
